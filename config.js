...
var palettes = require('./lib/wander/color-palettes.json');
var createRandomRange = require('./lib/wander/random-range');
...
module.exports = function (seed) {
  ...
  return {
    ...
    steps: Math.floor(random(120, 400)), // Change back to random
